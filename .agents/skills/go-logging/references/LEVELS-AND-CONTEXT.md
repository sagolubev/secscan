...
> Secscan project override: this reference was modified from upstream
> `cxuu/golang-skills@91f0c2e` because token prefixes are still secret
> material. Emit only the literal value `"redacted"`.
...
| Error messages | Yes | — |
| Passwords / tokens | **Never** | Log only `"redacted"` |
